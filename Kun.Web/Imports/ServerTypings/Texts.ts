namespace Kun.Texts {
    ...
    declare namespace Db {
        ...
        namespace Finance {
            ...
            namespace BillInvoiced {
                ...
                export const SourceDocumentNo: string;
                export const SourceDocumentType: string;
                export const SourceItemId: string;
                export const SourceItemSerial: string;
            }
            ...
            namespace Invoice {
                ...
                export const InvoiceNoWthAmount: string;
                export const ItemInvoiceAmount: string;
                export const Items: string;
                export const Note: string;
                export const ReceiptAmount: string;
                export const Status: string;
                export const UnReceiptAmount: string;
            }
        ...
        namespace Ops {
            ...
            namespace Maintenance {
                ...
                export const CommonExpression: string;
                export const Content: string;
                ...
                export const Description: string;
                export const Id: string;
                export const InvoicedAmount: string;
                export const ManAmount: string;
                export const Manhours: string;
                export const MateiralDetail: string;
                export const Materials: string;
                export const MaterialsAmount: string;
                export const Note: string;
                ...
                export const TotalSales: string;
                export const TypeId: string;
                export const TypeName: string;
                export const UnInvoicedAmount: string;
        ...
        namespace Project {
            ...
            namespace BizBill {
                ...
                export const Items: string;
                export const Note: string;
                export const ProjectBillNo: string;
            ...
            namespace BizItem {
                export const Amount: string;
                export const BillNo: string;
                export const BizType: string;
                export const BizTypeName: string;
                export const HeadId: string;
                export const HeadProjectId: string;
                export const HeadStatus: string;
                export const Id: string;
                export const Name: string;
                export const Note: string;
            ...
            namespace ProjectInfo {
                export const ActualAmount: string;
                export const Address: string;
                export const ApproverDate: string;
                export const ApproverId: string;
                export const ApproverName: string;
                export const BillNo: string;
                export const BillType: string;
                export const BizItems: string;
                export const BudgetAmount: string;
                ...
                export const PaymentName: string;
                export const PhoneNo: string;
                export const RetentionDueDate: string;
                export const ServiceItems: string;
                export const Status: string;
            }

            namespace ServiceBill {
                export const ApproverDate: string;
                export const ApproverId: string;
                export const ApproverName: string;
                export const BillNo: string;
        ...
        namespace Sell {
            ...
            namespace SaleOrderItem {
                ...
                export const Id: string;
                export const InvoicedAmount: string;
                export const InvoicedQty: string;
                export const LotCode: string;
                export const LotId: string;
                export const MaterialCode: string;
                export const MaterialId: string;
    ...
    Kun['Texts'] = Q.proxyTexts(Texts, '', {Db:{Administration:{DataAuditLog:{FieldName:1,LogDate:1,LogId:1,LogType:1,NewValue:1,OldValue:1,RecordId:1,Tablename:1,UserDisplayName:1,UserId:1,Username:1},Language:{Id:1,LanguageId:1,LanguageName:1},Role:{RoleId:1,RoleKey:1,RoleName:1},RolePermission:{PermissionKey:1,RoleId:1,RolePermissionId:1,RoleRoleName:1},Translation:{CustomText:1,EntityPlural:1,Key:1,OverrideConfirmation:1,SaveChangesButton:1,SourceLanguage:1,SourceText:1,TargetLanguage:1,TargetText:1},User:{DisplayName:1,Email:1,ImpersonationToken:1,InsertDate:1,InsertUserId:1,IsActive:1,LastDirectoryUpdate:1,MobilePhoneNumber:1,MobilePhoneVerified:1,Password:1,PasswordConfirm:1,PasswordHash:1,PasswordSalt:1,Source:1,TwoFactorAuth:1,UpdateDate:1,UpdateUserId:1,UserId:1,UserImage:1,Username:1},UserPermission:{Granted:1,PermissionKey:1,User:1,UserId:1,UserPermissionId:1,Username:1},UserRole:{RoleId:1,User:1,UserId:1,UserRoleId:1,Username:1}},Basic:{BizType:{Id:1,Name:1},CommonExpression:{Content:1,Id:1},Company:{Code:1,Description:1,Id:1,Name:1},Customer:{Code:1,Contacts:1,Description:1,Id:1,Mobile:1,Name:1},Lot:{Code:1,Id:1,MaterialId:1},Material:{Code:1,CodeName:1,GroupId:1,GroupName:1,Id:1,IsBatch:1,IsVirtual:1,Name:1,OldCode:1,SafetyStock:1,UnitCode:1,UnitId:1},MaterialGroup:{Code:1,Id:1,Name:1},PaymentItem:{Id:1,Name:1},Position:{Code:1,Id:1,Name:1,WarehouseId:1,WarehouseName:1},Supplier:{Code:1,Contacts:1,Description:1,Id:1,Mobile:1,Name:1},Unit:{Code:1,Decim:1,Id:1,Name:1},Vendor:{Code:1,Contacts:1,Description:1,Id:1,Mobile:1,Name:1},Warehouse:{Code:1,Description:1,Id:1,Name:1,UsePosition:1}},Common:{UserPreference:{Name:1,PreferenceType:1,UserId:1,UserPreferenceId:1,Value:1}},Finance:{BillInvoiced:{Amount:1,Id:1,InvoiceAmount:1,Kind:1,Qty:1,SourceDocumentId:1,SourceDocumentNo:1,SourceDocumentType:1,SourceItemId:1,SourceItemSerial:1},Invoice:{ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BillType:1,CompanyId:1,CompanyName:1,CustomerId:1,CustomerName:1,Date:1,Id:1,InvoiceAmount:1,InvoiceNo:1,InvoiceNoWthAmount:1,ItemInvoiceAmount:1,Items:1,Note:1,ReceiptAmount:1,Status:1,UnReceiptAmount:1},InvoiceItem:{Amount:1,BillNo:1,HeadDate:1,HeadId:1,HeadStatus:1,Id:1,InvoiceAmount:1,Kind:1,Name:1,Note:1,Price:1,Qty:1,ReceiptAmount:1,Serial:1,SourceDocumentId:1,SourceDocumentNo:1,SourceDocumentType:1,SourceItemId:1,SourceItemSerial:1,TaxRate:1,UnitName:1},Receipt:{ApproverDate:1,ApproverId:1,ApproverName:1,BalanceAmount:1,BillNo:1,Date:1,Id:1,InvoiceAmount:1,InvoiceNo:1,Note:1,ReceiptAmount:1,Status:1},ReceiptItem:{BalanceAmount:1,BillNo:1,HeadDate:1,HeadId:1,HeadStatus:1,Id:1,InvoiceAmount:1,Name:1,Note:1,ReceiptAmount:1,Serial:1,SourceDocumentId:1,SourceDocumentNo:1,SourceItemId:1,SourceItemSerial:1}},Ops:{Maintenance:{Address:1,ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BillType:1,ChangeDevice:1,CommonExpression:1,Content:1,CustomerComment:1,CustomerConfirmDate:1,Date:1,Description:1,Id:1,InvoicedAmount:1,ManAmount:1,Manhours:1,MateiralDetail:1,Materials:1,MaterialsAmount:1,Note:1,ReportCustomerId:1,ReportCustomerName:1,ReportDate:1,Reporter:1,ReporterComment:1,ReporterConfirmDate:1,ReporterPhone:1,ResponsibleId:1,ResponsibleName:1,ServicerCost:1,SettleCustomerId:1,SettleCustomerName:1,Status:1,TotalCost:1,TotalSales:1,TypeId:1,TypeName:1,UnInvoicedAmount:1,VendorId:1,VendorName:1},MaintenanceManhours:{Amount:1,BillNo:1,HeadId:1,HeadStatus:1,Id:1,ManhourId:1,ManhourName:1,Note:1,Price:1,Qty:1,Serial:1},MaintenanceMaterials:{BillNo:1,BuyAmount:1,BuyPrice:1,HeadId:1,HeadStatus:1,Id:1,LotCode:1,LotId:1,MaterialCode:1,MaterialId:1,MaterialName:1,PositionId:1,PositionName:1,Qty:1,SaleAmount:1,SalePrice:1,Serial:1,Specification:1,StockDataId:1,UnitId:1,UnitName:1,WarehouseId:1,WarehouseName:1},MaintenanceType:{Id:1,Name:1,Sort:1},ManhourPrice:{Id:1,Name:1,Price:1}},Project:{BizBill:{ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BillType:1,Date:1,Id:1,Items:1,Note:1,ProjectBillNo:1,ProjectId:1,ProjectName:1,Status:1},BizItem:{Amount:1,BillNo:1,BizType:1,BizTypeName:1,HeadId:1,HeadProjectId:1,HeadStatus:1,Id:1,Name:1,Note:1,ProjectBillNo:1,ProjectId:1,ProjectName:1,Serial:1},MaterialsBill:{ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BillType:1,Date:1,Id:1,Materials:1,Note:1,ProjectBillNo:1,ProjectId:1,ProjectName:1,Status:1},MaterialsItem:{BillNo:1,BuyAmount:1,BuyPrice:1,HeadId:1,HeadProjectId:1,HeadStatus:1,Id:1,LotCode:1,LotId:1,MaterialCode:1,MaterialId:1,MaterialName:1,Note:1,PositionId:1,PositionName:1,ProjectBillNo:1,ProjectId:1,ProjectName:1,Qty:1,SaleAmount:1,SalePrice:1,Serial:1,Specification:1,StockDataId:1,UnitId:1,UnitName:1,WarehouseId:1,WarehouseName:1},ProjectInfo:{ActualAmount:1,Address:1,ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BillType:1,BizItems:1,BudgetAmount:1,Contact:1,CustomerId:1,CustomerName:1,Date:1,Id:1,InvoicedAmount:1,IsClosed:1,Materials:1,Name:1,Note:1,Payment:1,PaymentName:1,PhoneNo:1,RetentionDueDate:1,ServiceItems:1,Status:1},ServiceBill:{ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BillType:1,Date:1,Id:1,Items:1,Note:1,ProjectBillNo:1,ProjectId:1,ProjectName:1,Status:1},ServiceItem:{Amount:1,BillNo:1,HeadId:1,HeadProjectId:1,HeadStatus:1,Id:1,Name:1,Note:1,Price:1,ProjectBillNo:1,ProjectId:1,ProjectName:1,Qty:1,Serial:1}},Sell:{SaleOrder:{ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BillType:1,CustomerId:1,CustomerName:1,Date:1,Id:1,InvoicedAmount:1,Materials:1,Note:1,SettleCustomerId:1,SettleCustomerName:1,Status:1,TotalCost:1,TotalSales:1,UnInvoicedAmount:1},SaleOrderItem:{BillNo:1,BuyAmount:1,BuyPrice:1,CustomerId:1,CustomerName:1,HeadDate:1,HeadId:1,HeadStatus:1,Id:1,InvoicedAmount:1,InvoicedQty:1,LotCode:1,LotId:1,MaterialCode:1,MaterialId:1,MaterialName:1,PositionId:1,PositionName:1,Qty:1,SaleAmount:1,SalePrice:1,Serial:1,Specification:1,StockDataId:1,StockQty:1,UnInvoicedAmount:1,UnitId:1,UnitName:1,WarehouseId:1,WarehouseName:1}},Stock:{Assemble:{ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BuyAmount:1,BuyPrice:1,Date:1,Id:1,Items:1,LotCode:1,LotId:1,Note:1,PositionId:1,PositionName:1,Qty:1,Status:1,StockDataId:1,ToMaterialCode:1,ToMaterialId:1,ToMaterialName:1,UnitId:1,UnitName:1,WarehouseId:1,WarehouseName:1},AssembleItem:{BillNo:1,BuyAmount:1,BuyPrice:1,HeadDate:1,HeadId:1,HeadStatus:1,Id:1,LotCode:1,LotId:1,MaterialCode:1,MaterialId:1,MaterialName:1,PositionId:1,PositionName:1,Qty:1,Serial:1,Specification:1,Status:1,StockDataId:1,UnitId:1,UnitName:1,WarehouseId:1,WarehouseName:1},ChangeStock:{ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BillType:1,Date:1,Id:1,Items:1,Note:1,Status:1},ChangeStockItem:{BillNo:1,ChangeCode:1,FromBuyPrice:1,FromLotCode:1,FromLotId:1,FromMaterialCode:1,FromMaterialId:1,FromMaterialName:1,FromPositionId:1,FromPositionName:1,FromSalePrice:1,FromSpecification:1,FromStockId:1,FromUnitId:1,FromUnitName:1,FromWarehouseId:1,FromWarehouseName:1,HeadDate:1,HeadId:1,HeadStatus:1,Id:1,Qty:1,Serial:1,Status:1,ToBuyPrice:1,ToLotCode:1,ToLotId:1,ToMaterialCode:1,ToMaterialId:1,ToMaterialName:1,ToPositionId:1,ToPositionName:1,ToSalePrice:1,ToSpecification:1,ToStockId:1,ToUnitId:1,ToUnitName:1,ToWarehouseId:1,ToWarehouseName:1},InStock:{ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BillType:1,Date:1,Id:1,Items:1,Note:1,Status:1},InStockItem:{ApplicantId:1,ApplicantName:1,ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,BuyAmount:1,BuyPrice:1,ConfirmQty:1,DeliveryQty:1,HeadDate:1,HeadId:1,HeadStatus:1,Id:1,InvoiceType:1,InvoiceTypeName:1,LotCode:1,LotId:1,MaterialCode:1,MaterialId:1,MaterialName:1,PositionId:1,PositionName:1,SaleAmount:1,SalePrice:1,Serial:1,Specification:1,Status:1,SupplierId:1,SupplierName:1,UnitId:1,UnitName:1,WarehouseId:1,WarehouseName:1},MoveRecord:{BizBillCode:1,BizBillId:1,BizBillType:1,BizItemId:1,FromLotCode:1,FromLotId:1,FromMaterialCode:1,FromMaterialId:1,FromMaterialName:1,FromPositionId:1,FromPositionName:1,FromStockId:1,FromUnitId:1,FromUnitName:1,FromWarehouseId:1,FromWarehouseName:1,Id:1,MovCode:1,Qty:1,Status:1,ToLotCode:1,ToLotId:1,ToMaterialCode:1,ToMaterialId:1,ToMaterialName:1,ToPositionId:1,ToPositionName:1,ToStockId:1,ToUnitId:1,ToUnitName:1,ToWarehouseId:1,ToWarehouseName:1},OutStock:{ApproverDate:1,ApproverId:1,ApproverName:1,BillNo:1,Date:1,Id:1,Materials:1,Note:1,Status:1},OutStockItem:{ApplicantId:1,ApplicantName:1,BillNo:1,BuyAmount:1,BuyPrice:1,HeadDate:1,HeadId:1,HeadStatus:1,Id:1,LotCode:1,LotId:1,MaterialCode:1,MaterialId:1,MaterialName:1,PositionId:1,PositionName:1,Qty:1,Serial:1,Specification:1,StockDataId:1,StockQty:1,UnitId:1,UnitName:1,Usage:1,WarehouseId:1,WarehouseName:1},StockData:{Applicant:1,AvailableQty:1,BuyAmount:1,BuyPrice:1,Id:1,LotCode:1,LotId:1,MaterialCode:1,MaterialId:1,MaterialName:1,PositionId:1,PositionName:1,Qty:1,ReservedQty:1,SaleAmount:1,SalePrice:1,Specification:1,UnitId:1,UnitName:1,WarehouseId:1,WarehouseName:1}},Sys:{DocumentCodeConfig:{DocumentCodePrefix:1,DocumentKind:1,Id:1}}},Forms:{Membership:{ChangePassword:{FormTitle:1,SubmitButton:1,Success:1},ForgotPassword:{BackToLogin:1,FormInfo:1,FormTitle:1,SubmitButton:1,Success:1},Login:{FacebookButton:1,ForgotPassword:1,FormTitle:1,GoogleButton:1,OR:1,RememberMe:1,SignInButton:1,SignUpButton:1},ResetPassword:{BackToLogin:1,EmailSubject:1,FormTitle:1,SubmitButton:1,Success:1},SignUp:{AcceptTerms:1,ActivateEmailSubject:1,ActivationCompleteMessage:1,BackToLogin:1,ConfirmEmail:1,ConfirmPassword:1,DisplayName:1,Email:1,FormInfo:1,FormTitle:1,Password:1,SubmitButton:1,Success:1}}},Site:{AccessDenied:{ClickToChangeUser:1,ClickToLogin:1,LackPermissions:1,NotLoggedIn:1,PageTitle:1},BasicProgressDialog:{CancelTitle:1,PleaseWait:1},BulkServiceAction:{AllHadErrorsFormat:1,AllSuccessFormat:1,ConfirmationFormat:1,ErrorCount:1,NothingToProcess:1,SomeHadErrorsFormat:1,SuccessCount:1},CardViewMixin:{CardView:1,ListView:1},Dashboard:{ContentDescription:1},Dialogs:{PendingChangesConfirmation:1},DraggableGroupingMixin:{CollapseAllButton:1,DropPlaceholder:1,ExpandAllButton:1},EmailClient:{BackButton:1,CCLabel:1,CancelButton:1,ComposeButton:1,DeleteButton:1,DeleteMessageConfirmation:1,DeleteMessageSuccess:1,DeleteNoSelectionWarning:1,DeleteSelectedConfirmation:1,DeleteSelectedSuccess:1,FolderNames:{drafts:1,inbox:1,junk:1,sent:1,trash:1},FoldersTitle:1,ForwardButton:1,ImapHost:1,ImapPassword:1,ImapPort:1,ImapUsername:1,LoginButton:1,LoginTitle:1,MoveMessageSuccess:1,MoveNoSelectionWarning:1,MoveSelectedSuccess:1,MoveToFolder:1,NewEmailDialogTitle:1,PageTitle:1,QuickSettings:1,RefreshButton:1,ReplyAllButton:1,ReplyButton:1,ReplyEmailDialogTitle:1,SearchPlaceholder:1,SendButton:1,SignoutButton:1,SmtpHost:1,SmtpPassword:1,SmtpPort:1,SmtpUsername:1,ToLabel:1,ToggleReadButton:1,ToggleSeenNoSelectionWarning:1},FavoriteViewsMixin:{DeleteButtonHint:1,DeleteSuccessMessage:1,EmptyNameError:1,FavoriteViews:1,LoadedViewMessage:1,SaveButton:1,SaveSuccessMessage:1,SaveView:1},HeaderFiltersMixin:{CancelButton:1,ClearButton:1,OkButton:1,Search:1,SelectAll:1},Layout:{FooterCopyright:1,FooterInfo:1,FooterRights:1,GeneralSettings:1,Language:1,Theme:1,ThemeAzure:1,ThemeAzureLight:1,ThemeBlack:1,ThemeBlackLight:1,ThemeBlue:1,ThemeBlueLight:1,ThemeCosmos:1,ThemeCosmosLight:1,ThemeGlassy:1,ThemeGlassyLight:1,ThemeGreen:1,ThemeGreenLight:1,ThemePurple:1,ThemePurpleLight:1,ThemeRed:1,ThemeRedLight:1,ThemeYellow:1,ThemeYellowLight:1},RolePermissionDialog:{DialogTitle:1,EditButton:1,SaveSuccess:1},UserDialog:{EditPermissionsButton:1,EditRolesButton:1},UserPermissionDialog:{DialogTitle:1,Grant:1,Permission:1,Revoke:1,SaveSuccess:1},UserRoleDialog:{DialogTitle:1,SaveSuccess:1},ValidationError:{Title:1},WizardDialog:{BackButton:1,CancelMessage:1,FinishButton:1,NextButton:1}},Validation:{AuthenticationError:1,CantFindUserWithEmail:1,CurrentPasswordMismatch:1,DeleteForeignKeyError:1,EmailConfirm:1,EmailInUse:1,InvalidActivateToken:1,InvalidResetToken:1,MinRequiredPasswordLength:1,SavePrimaryKeyError:1}});
}
