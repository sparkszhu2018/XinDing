...
namespace Kun.Administration.Repositories
{
    ...
    public partial class UserRepository
    {
        ...
        public static bool IsValidPhone(string number)
        {
            ...
            long n;
            return !number.IsNullOrEmpty() && number.Length > 7 && long.TryParse(number, out n);
        }
        ...
        private class MyListHandler : ListRequestHandler<MyRow, UserListRequest>
        {
            protected override void OnReturn()
            {
                ...
                if (Request.DataProtector != null &&
                    ...
                    Authorization.HasPermission("ImpersonateAs") &&
        ...
        {
            return LocalCache.Get("ImpersonationToken:" + clientHash + ":" + username,
