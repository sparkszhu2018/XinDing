...
namespace Kun.Administration.Repositories
{
    ...
    public class UserPermissionRepository
    {
        ...
        public ListResponse<string> ListPermissionKeys(bool includeRoles = false)
        {
            return TwoLevelCache.GetLocalStoreOnly("Administration:PermissionKeys:" +
                (includeRoles ? "IR" : "XR"), TimeSpan.Zero,
                RoleRow.Fields.GenerationKey, () =>
            {
                ...
                if (includeRoles)
                {
                    foreach (var role in RoleRepository.RoleById.Values)
