...
namespace Kun.Ops.Entities
{
    ...
    [ConnectionKey("Kun"), Module("Ops"), TableName("[dbo].[OPS_Maintenance_Materials]")]
    [DisplayName("维保单用料"), InstanceName("维保单用料")]
    [ReadPermission("*")]
    [ModifyPermission("*")]
    public sealed class MaintenanceMaterialsRow : Kun.Administration.Entities.LoggingAllRow, IIdRow, INameRow
    {
        ...
        {
            get { return Fields.MaterialCode; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public MaintenanceMaterialsRow()
            : base(Fields)
        {
        }
