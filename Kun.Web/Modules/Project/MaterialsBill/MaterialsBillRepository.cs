...
namespace Kun.Project.Repositories
{
    ...
    using MyRow = Entities.MaterialsBillRow;

    public class MaterialsBillRepository
    {
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow>
        {
            protected override void SetInternalFields()
            {
                ...
                if (IsCreate)
                {
                    ...
                    var prefix = new DocumentCodeConfigRepository().GetDocumentCodePrefix(Connection, Sys.Enum.DocumentKind.ProjectMaterials);
