...
namespace Kun.Project.Entities
{
    ...
    [ConnectionKey("Kun"), Module("Project"), TableName("[dbo].[Project_MaterialsBill]")]
    [DisplayName("Materials Bill"), InstanceName("Materials Bill")]
    [ReadPermission("*")]
    [ModifyPermission("*")]
    public sealed class MaterialsBillRow : Kun.Administration.Entities.LoggingAllRow, IIdRow, INameRow
    {
