...
namespace Kun.Project.Entities
{
    ...
    [DisplayName("项目服务"), InstanceName("项目服务")]
    [ReadPermission("*")]
    [ModifyPermission("*")]
    public sealed class ServiceBillRow : Kun.Administration.Entities.LoggingAllRow, IIdRow, INameRow
    {
        ...
        [DisplayName("服务成本"), NotMapped, MasterDetailRelation(foreignKey: "HeadId", IncludeColumns = "HeadStatus")]
        public List<ServiceItemRow> Items
        {
        ...
        public class RowFields : Kun.Administration.Entities.LoggingAllRowFields
        {
            ...
            public RowListField<ServiceItemRow> Items;
        }
    }
}
