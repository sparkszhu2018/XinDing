...
namespace Kun.Sell.Endpoints
{
    ...
    using MyRepository = Repositories.SaleOrderRepository;
    using MyRow = Entities.SaleOrderRow;
    using System;
    using static Kun.Sell.Enums.SellEnums;

    [Route("Services/Sell/SaleOrder/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class SaleOrderController : ServiceEndpoint
    {
