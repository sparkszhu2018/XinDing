...
namespace Kun.Stock.Entities
{
    ...
    [ConnectionKey("Kun"), Module("Stock"), TableName("[dbo].[Stock_ChangeStock]")]
    [DisplayName("移库单"), InstanceName("移库单")]
    [ReadPermission("*")]
    [ModifyPermission("*")]
    public sealed class ChangeStockRow : Kun.Administration.Entities.LoggingAllRow, IIdRow, INameRow
    {
        ...
        [DisplayName("单据编号"), Size(50), QuickSearch, QuickFilter]
        ...
        public class RowFields : Kun.Administration.Entities.LoggingAllRowFields
        {
            ...
            public RowListField<ChangeStockItemRow> Items;
        }
    }
}
