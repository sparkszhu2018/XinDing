...
namespace Kun.Stock.Entities
{
    ...
    [ConnectionKey("Kun"), Module("Stock"), TableName("[dbo].[Stock_OutStock_Item]")]
    [DisplayName("出库明细"), InstanceName("出库明细")]
    [ReadPermission("*")]
    [ModifyPermission("*")]
    public sealed class OutStockItemRow : Kun.Administration.Entities.LoggingAllRow, IIdRow, INameRow
    {
        ...
        [DisplayName("Head Id"), NotNull, ForeignKey("[dbo].[Stock_OutStock]", "Id"), LeftJoin("jHead"), Updatable(false)]
        public Guid? HeadId
        {
